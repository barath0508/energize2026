...
const sponsors = [
  'TechCorp', 'NexGen AI', 'CyberShield', 'QuantumLabs', 'DevStack', 'CloudNine',
  'ByteForge', 'DataPulse', 'CodeVault', 'InnovateTech', 'SynthWave', 'GridLock',
];
  ...
  >
    ...
    >
      {[...items, ...items].map((name, i) => (
        <div 
          key={i}
          className="h-20 w-44 bg-carbon border border-white/10 rounded-sm flex items-center justify-center shrink-0 hover:border-primary/50 hover:bg-[#111] hover:shadow-[0_0_20px_rgba(250,204,21,0.15)] hover:scale-105 transition-all duration-300 cursor-pointer group/item"
        >
  ...
  return (
    <section id="sponsors" ref={sectionRef} className="py-24 md:py-32 relative z-10 border-t border-white/5 bg-black overflow-hidden">
      <div className="container mx-auto px-6 md:px-12 text-center mb-12">
        ...
        <p className="text-zinc-500 text-sm">Our partners and sponsors power the mission.</p>
      </div>
