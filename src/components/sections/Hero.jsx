      ...
      <div className="hero-content container mx-auto text-center relative z-20">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            className={`hero-btn w-full sm:w-auto px-8 py-4 ${isClosed ? 'bg-accent/20 border border-accent/30 text-accent' : 'bg-primary text-black'} font-bold text-lg hover:bg-primary-dark transition-all rounded-sm border-glow active:scale-95 uppercase tracking-wider ${!isClosed ? 'hover:shadow-[0_0_30px_rgba(0,230,118,0.4)]' : ''} hover:-translate-y-0.5 duration-300 inline-block text-center`}
          >
