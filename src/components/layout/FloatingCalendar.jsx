  ...
  return (
    ...
    >
      ...
      <div className="absolute right-full mr-4 bg-carbon border border-white/10 px-4 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none group-hover:-translate-x-2 duration-300">
        ...
        <p className="text-xs text-zinc-400">Oct 24-25, 2026</p>
      </div>
      
      <div className="w-14 h-14 bg-background border border-primary text-primary rounded-full flex items-center justify-center border-glow relative hover:scale-110 transition-transform duration-300 shadow-[0_0_20px_rgba(250,204,21,0.2)]">
